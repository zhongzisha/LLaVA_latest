...
if __name__ == '__main__':
    ...
    elif args.target_test_type == "test-answer-file-run1":
        target_test_file = "test-answer-file-run1.jsonl"
        answers_file = "eval_results_med_datasets_run1.jsonl"
        dataset_list = [args.gt.split('/')[-2]]  # data_RAD, Slake1.0, pvqa
        test_gt_file = "test.json"  
    ...
    for f in jsonl_files:
        for ds in dataset_list:
            if ds in f:
                ...
                args.gt = "/lscratch/{}/finetune_data_LLaVA-Med/{}/{}".format(os.environ['SLURM_JOB_ID'], ds, test_gt_file)
                args.pred = f
                ...
                args.candidate = "/lscratch/{}/finetune_data_LLaVA-Med/{}/train_open_answers.json".format(os.environ['SLURM_JOB_ID'], ds)
