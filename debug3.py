...
def eval():
    ...
    class CustomDataset(torch.utils.data.Dataset):
        def __init__(self, questions, image_folder, tokenizer, image_processor, conversation, model_config):
            ...
            for index in range(len(self.questions)):
                if conversation.sep_style in [SeparatorStyle.LLAMA_3, SeparatorStyle.QWEN_2]:
    ...
    elif conv_version == 'qwen_2': # for fine tune
        conv_llava = Conversation(
...
def train_with_hf_trainer(): 
    ...
    elif model_args.conv_version == 'qwen_2': # for fine tune
        conv_llava = Conversation(
            system="You are a helpful assistant.",
            roles=("user", "assistant"),
            version="qwen_2",
